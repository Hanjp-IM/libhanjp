...
struct _HanjpInputContextClass
{
    ...
    const gunichar* (*get_preedit_string) (HanjpInputContext *self);
    const gunichar* (*get_commit_string) (HanjpInputContext *self);
    const gunichar* (*get_hangul_string) (HanjpInputContext *self);
